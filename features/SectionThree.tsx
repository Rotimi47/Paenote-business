...
export default function SectionThree() {
  return (
    <div className="flex flex-col gap-40 lg:gap-60  bg-neutral-950 w-full px-4 pt-20 pb-40 mx-auto lg:pt-40 lg:pb-50 lg:px-30">
        <div className="flex flex-col 2xl:max-w-380 2xl:mx-auto gap-16 lg:gap-24">
            <div className="flex flex-col gap-16 lg:gap-12">  
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div className="bg-neutral-870  p-4 lg:p-6 h-100 lg:max-h-120 rounded-xl shadow-inset flex flex-col">
                    ...
                    <div className="lg:col-span-2 bg-neutral-870  p-4 lg:p-6 h-100 lg:max-h-120 rounded-xl shadow-inset flex flex-col">
                        <div className="mt-auto"> 
