  ...
  return (
    <div className=" bg-brand-pure mx-1.5 rounded-[20px] overflow-hidden 2xl:max-w-380 2xl:mx-auto">
        <div className="lg:flex  ">
            ...
            <div className=" flex flex-col gap-6 py-8 px-4 lg:pl-28 lg:pt-30 lg:max-w-180">
            ...
            <div className="relative right-10 lg:right-40 lg:top-10">
                <Image src="/images/heroImage.svg" alt="Iphone"  width={960} height={892} priority className="w-full max-w-120 lg:max-w-240 h-auto"/>
